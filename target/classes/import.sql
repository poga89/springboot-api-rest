...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('polo','$2a$10$C3Uln5uqnzx/GswADURJGOIdBqYrly9731fnwKDaUdBkt/M3qvtLq',1, 'Andres', 'Guzman','polo@bolsadeideas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$RmdEsvEfhI7Rcm9f/uZXPebZVCcPC7ZXZwV51efAvMAp1rIaRAfPK',1, 'John', 'Doe','admin@bolsadeideas.com');
...
INSERT INTO productos(nombre, precio, create_at) VALUES('Apple ipod shuffle', 2500700, NOW());
INSERT INTO productos(nombre, precio, create_at) VALUES('Sony Notebook Z110', 3547000, NOW());
INSERT INTO productos(nombre, precio, create_at) VALUES('Portatil MSI PS42', 4300000, NOW());
INSERT INTO productos(nombre, precio, create_at) VALUES('Celular Zony Z5', 789990, NOW());
...
INSERT INTO facturas (descripcion, observacion, cliente_id, create_at) VALUES ('Factura casa nueva', 'Alguna Nota Importante', 1, NOW());
